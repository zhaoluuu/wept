import*as UI from"../ui/ui.js";export class ContextDetailBuilder{constructor(t){this._fragment=createDocumentFragment(),this._container=document.createElement("div"),this._container.classList.add("context-detail-container"),this._fragment.appendChild(this._container),this._build(t)}_build(t){const e="realtime"===t.contextType?ls`AudioContext`:ls`OfflineAudioContext`;this._addTitle(e,t.contextId),this._addEntry(ls`State`,t.contextState),this._addEntry(ls`Sample Rate`,t.sampleRate,"Hz"),"realtime"===t.contextType&&this._addEntry(ls`Callback Buffer Size`,t.callbackBufferSize,"frames"),this._addEntry(ls`Max Output Channels`,t.maxOutputChannelCount,"ch")}_addTitle(t,e){this._container.appendChild(UI.Fragment.html`
