        ...
        var e = {
                    ...
                    Object.create && (n.prototype = Object.create(null), (new n).__proto__ || (o = !1)), i.prototype.eventNames = function() {
                        ...
                        if (d.fn) {
                            switch (d.once && this.removeListener(e, d.fn, void 0, !0), u) {
                                ...
                                case 6:
                                    return d.fn.call(d.context, t, n, r, i, a), !0
                            }
                        ...
                        if (s.fn) s.fn !== t || i && !s.once || r && s.context !== r || (0 == --this._eventsCount ? this._events = new n : delete this._events[a]);
                            ...
                            for (var c = 0, l = [], d = s.length; c < d; c++)(s[c].fn !== t || i && !s[c].once || r && s[c].context !== r) && l.push(s[c]);
                            l.length ? this._events[a] = 1 === l.length ? l[0] : l : 0 == --this._eventsCount ? this._events = new n : delete this._events[a]
                        }
                        return this
                ...
                8998: (e, t, o) => {
                    var n = o(1851),
                        ...
                        l = o(4962);
                    t = function(e, t, o) {
                        return null == e ? c : n(e) ? a(e, t, o) : r(e) && !i(e) ? s(e) : l(e)
                    }, e.exports = t
                },
                7059: (e, t, o) => {
                    var n = o(6093),
                ...
                6391: (e, t, o) => {
                    ...
                    e.exports = function(e) {
                        ...
                        return s.once("RESET_INSTANCE", (() => {
                            c = !0, n.removeCallback(d)
                        })), l || (l = !0, n.registerCallback(d)), {
                            beforeinvoke: function(s, l, d, g) {
                                if (c) return;
                                const {
                                    isAsync: p,
                                    preventDefault: f,
                                ...
                                if (p) t[v] = _, n.send({
                                    ...
                                    e.needImplement ? r[s](s, l, _) : _(e)
                                }
                            },
                            afterinvoke: function(r, s, l, d) {
                                if (c) return;
                                const {
                                    isAsync: g,
                                    preventDefault: p,
                ...
                4712: (e, t, o) => {
                    ...
                    __global.getHookMethodsCache = $, p.on("RESET_INSTANCE", (() => {
                        ...
                        const C = o => {
                                ...
                                } else "APPSERVICE_INVOKE_EMITTER" === n ? p.emit("triggerOnEvent", i.name, i.payload) : "API_MOCK_STATUS_CHANGE" === n ? A = i : "API_MOCK_APILIST_CHANGE" === n ? D = i.apiList : "APPSERVICE_ON_EVENT" === n && "onManualRedirect" === (null == i ? void 0 : i.eventName) && a.manualCancelList.push(null == i ? void 0 : i.data);
                                "MODIFY_COMPONENT_DATA" === n && w(i.id, i.componentData, i.webviewId), "UPDATE_APPDATA_PANEL_DATA" === n && r.send({
                        ...
                        return p.once("RESET_INSTANCE", (() => {
                            ...
                            invoke: function(p, f, h) {
                                ...
                                const R = d.sync(p, T);
                                R.needImplement ? a[p](p, f, w) : (_(R), delete R.to, w(R))
                            }
                        }
                    }
                },
                5082: (e, t, o) => {
                    ...
                    e.exports = function() {
                        ...
                        return s || (s = !0, i.registerCallback(l)), e.on("triggerOnEvent", (function(e, t, o) {
                            c(e, t, o)
                ...
                1227: (e, t, o) => {
                    ...
                    e.exports = function(e) {
                        ...
                        function g(r, i, l, d) {
                            var u;
                            if (!t) {
                                if (l = l ? l.filter((e => void 0 !== e)) : [], s.debugLog(`${new Date} WeixinJSBridge publish ${r}`, arguments), i && 0 !== r.indexOf("canvas")) {
                                ...
                                s.debugInfo({
                                    ...
                                    data: arguments,
                                    timesmap: new Date
                                }), "appDataChange" !== r && "pageInitData" !== r && "__updateAppData" !== r || d || n((() => {
                                    c.send({
                                        command: "SEND_APP_DATA",
                                        data: a.getWxAppData(),
                                        common: e
                        ...
                        return l.once("RESET_INSTANCE", (() => {
                            t = !0, c.removeCallback(u)
                        })), d || (d = !0, c.registerCallback(u)), {
                            publish: g
                        }
                    }
                },
                        ...
                        return s.once("RESET_INSTANCE", (() => {
                            ...
                            publishSync: function(o, s, c) {
                                ...
                                if (c = c ? c.filter((e => void 0 !== e)) : [], r.debugLog(`${new Date} WeixinJSBridge publishsync ${o}`, arguments), r.debugInfo({
                                        ...
                                        data: arguments,
                                        timesmap: new Date
                                    }), 0 === c.length && (l = ["fail no such target", null]), l = i.sync("publishsync", {
                                        eventName: o,
                                        data: s,
                                        webviewIds: c
                                    }, 1e4, "fail timeout"), l[0]) throw new Error(l[0]);
                    ...
                    e.exports = {
                        ...
                        setAudioState: (e, t, o) => {
                            ...
                            try {
                                ...
                                p.loop = u || !1, p.autoplay = l || !1, p.referrerPolicy = g || "no-referrer", f = parseFloat(f), p.volume = isNaN(f) ? 1 : Math.max(0, Math.min(1, f));
                                let h = 1;
                ...
                411: (e, t, o) => {
                    ...
                    const u = (e, t) => {
                        ...
                        f = () => {
                            d && !d.ended && (d.error || u(s.SIMULATOR_SET_BACKGROUND_AUDIO, {
                        ...
                        h = () => {
                            d && (u(s.SIMULATOR_SET_BACKGROUND_AUDIO, {
                    ...
                    const y = () => {
                        d.play(), d.removeEventListener("canplay", y)
                    };

                    function b() {
                        d && (d.removeEventListener("play", p), d.removeEventListener("pause", f), d.removeEventListener("ended", h), d.removeEventListener("waiting", m), d.removeEventListener("canPlay", _), d.removeEventListener("canPlay", y), d.removeEventListener("error", v), d.pause(), d.remove(), d = null)
                    }
                    e.exports = {
                        initMusic: function() {
                            d || (d = a.document.createElement("audio"), d.addEventListener("play", p), d.addEventListener("pause", f), d.addEventListener("ended", h), d.addEventListener("waiting", m), d.addEventListener("canplay", _), d.addEventListener("error", v))
                        },
                        playMusic: function(e = {}) {
                            if (d.removeEventListener("canplay", y), e.src && e.src !== d._src) {
                                d._src = e.src, d.src = "origin" === d.referrerPolicy ? `${e.src}${l.referrerPolicyOrigin}` : `${e.src}${l.referrerPolicyNoReferrer}`;
                                let t = 1;
                                "number" == typeof(null == e ? void 0 : e.playbackRate) && (t = Math.min(Math.max(e.playbackRate, .5), 2)), d.addEventListener("canplay", y), d.load(), d.playbackRate = t || d.playbackRate || 1, d.currentTime = e.startTime || 0
                            } else d.src && d.play()
                        },
                        pauseMusic: function() {
                            return !!d && (d.paused || d.pause(), !0)
                        },
                        resumeMusic: function() {
                            (null == d ? void 0 : d.paused) && d.play()
                        },
                        stopMusic: function() {
                            if (!d) return !1;
                            const e = d._src;
                        ...
                        seekMusic: function(e = {}) {
                            d && (d.currentTime = 1 * e.currentTime, d.paused || d.dispatchEvent(new Event("play")))
                        },
                        getAudioBufferd: function() {
                            const e = d ? d.buffered : "";
                            if (e) {
                ...
                3742: (e, t, o) => {
                    ...
                    r.on("RESET_INSTANCE", (() => {
                        ...
                        i = e, c.all = !0
                    })), t.getSystemInfoSync = d, t.getSystemInfo = function(e, t, o) {
                        return d(0, t, o)
                    }
                },
                8665: e => {
                ...
                6955: (e, t, o) => {
                    ...
                    const n = o(3161),
                        ...
                        l = o(9464),
                        d = o(9613),
                        u = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, n), r), i), a), s), c), l), d);
                    e.exports = u
                },
                9613: (e, t, o) => {
                    "use strict";
                    ...
                    r.registerCallback((e => {
                        ...
                        "LOAD_APPSERVICE" === t ? f() : "BACKGROUND_AUDIO_STOP" === t ? l() : "BACKGROUND_AUDIO_PAUSE" === t ? d() : "BACKGROUND_AUDIO_RESUME" === t && c()
                    }));
                    const y = (e, t) => {
                        r.send({
                            command: "APPSERVICE_SDK_BACKGROUND_AUDIO_ACTION",
                    ...
                    e.exports = {
                        ...
                        operateBackgroundAudio: function(e, t, o) {
                            ...
                            try {
                                ...
                                else if ("stop" === n) l(), y(h.SIMULATOR_SET_BACKGROUND_AUDIO, {
                                    status: m.MUSIC_STATE_END
                                });
                                else {
                ...
                3161: (e, t, o) => {
                    ...
                    const w = (e, t, o, a) => {
                            ...
                            if ("manual" === A) {
                                new URL(t.url).search ? t.url += "&_wx_redirect=manual" : t.url += "?_wx_redirect=manual"
                            }
                            if (function(e, t, o) {
                                    const {
                                        url: r,
                                    ...
                                    if (s.isReady) {
                                        if (!s.isSecuryTLS) return y(s, o), !0;
                                        if (!s.isSecuryCertificate) return b(s, o), !0
                                    }
                                    return !1
                                }(e, t, h)) return;
                            const D = function() {
                            ...
                            let O = 0;
                            const R = new D;
                            R.disableHttp2 = !t.enableHttp2, R.responseType = w || "text", t.enableChunked && (R.responseType = "text"), R.timeout = t.timeout || (null === (u = __wxConfig.networkTimeout) || void 0 === u ? void 0 : u.request) || 6e4, R.open(I, t.url, !0), R.onreadystatechange = () => {
                                if (R.readyState === (R.HEADERS_RECEIVED || 2)) try {
                                    let o = {};
                                    try {
                                        o = JSON.parse(R.getResponseHeader("for-weapp-devtools"))
                                    } catch (s) {}
                                    "function" == typeof a && i.libNumberVersion >= 1009093 && a({
                                ...
                                if (R.readyState, 4 === R.readyState) {
                                    ...
                                    if (0 === u);
                                        ...
                                        const g = n.getSecuryDetailsByURL(t.url);
                                        let p = {};
                                        try {
                                            p = JSON.parse(R.getResponseHeader("for-weapp-devtools"))
                                        } catch (m) {}

                                        function f(o) {
                                            if (!o.isSecuryTLS) return void y(o, h);
                                            if (!o.isSecuryCertificate) return void b(o, h);
                                            if (R.responseURL && !S && !d(R.responseURL)) return void h({
                                                errMsg: `${e}:fail ${l}`
                                            });
                                            const n = {
                                                errMsg: `${e}:ok`,
                                            ...
                                            "arraybuffer" === R.responseType ? n.data = R.response : n.data = R.responseText, t.enableChunked && (n.data = ""), h(n)
                                        }
                                        g.isReady ? f(g) : r.instanceScope().once(`TLS_CHECK_READY_${g.id}`, f)
                                    }
                                }
                            }, R.onprogress = function() {
                                var e, o;
                                if (t.enableChunked && !t.enableHttp2 && "chunked" === R.getResponseHeader("transfer-encoding") && "function" == typeof a && i.libNumberVersion >= 1009093) try {
                                    const t = null === (e = R.responseText) || void 0 === e ? void 0 : e.length;
                                    if (O === t) return;
                                    R.timeout = 0;
                                    const n = null === (o = R.responseText) || void 0 === o ? void 0 : o.substring(O, t);
                                    O = t, a({
                                        state: "chunked",
                                        data: C(n)
                                    })
                                ...
                                var o;
                                const n = v.findIndex((e => e.url === t.url));
                                if (n > -1) {
                                    const t = JSON.parse((null === (o = v[n].responseHeaders.find((e => "for-weapp-devtools" === e.name))) || void 0 === o ? void 0 : o.value) || "{}"),
                                        r = {
                                            header: k(t),
                                            cookies: E(t),
                                            statusCode: v[n].statusCode
                                        };
                                    "function" == typeof a && a(Object.assign(Object.assign({}, r), {
                                        state: "headersReceived"
                            ...
                            let M = 0;
                            for (const e in T) "content-type" === e.toLowerCase() && M++;
                            M >= 2 && delete T["content-type"];
                            let P = !1;
                            for (const t in T)
                                if (T.hasOwnProperty(t)) {
                                    ...
                                    P = "content-type" === o || P;
                                    try {
                                        m[o] || 0 === t.indexOf(_) ? R.setRequestHeader(`${_}${t}`, n) : R.setRequestHeader(t, T[t])
                                    } catch (t) {
                                        return void h({
                                            errMsg: `${e}:fail ${t}`
                                        })
                            ...
                            "POST" !== I || P || R.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8");
                            const x = t.data;
                            try {
                                R.send(x)
                            } catch (t) {
                    ...
                    e.exports = {
                        ...
                        createRequestTask: (e, t, o) => {
                            ...
                            i.xhr = w("request", t, i.callback.bind(void 0, i.id), (function(e) {
                ...
                6622: (e, t, o) => {
                    ...
                    window.addEventListener("networkChange", (e => {
                        ...
                        connectSocket: (e, t, o) => {
                            ...
                            if ("none" === r.DevtoolsConfig.networkStatus) return _(i), void d({
                                errMsg: `${e}:fail network is down`
                            });
                            if (!s(i, "socket")) return void d({
                                errMsg: `connectSocket:fail ${r.urlCheckErrReason}`
                            });
                            const y = p(i, l);
                            if (y && Object.keys(y).length > 0 && g(y), v && (v.readyState === f.OPEN || v.readyState === f.CONNECTING)) return void d({
                        ...
                        createSocketTask: (e, t, o) => {
                            ...
                            if (!w && !s(v, "socket")) return void setTimeout((() => {
                            ...
                            const A = setTimeout((() => {
                                ...
                                }), delete l[S], null === (e = null == I ? void 0 : I.close) || void 0 === e || e.call(I)
                            }), C);
                ...
                9970: (e, t, o) => {
                    ...
                    function d() {
                        c || (c = !0, r.registerCallback((e => {
                            ...
                            "APPSERVICE_STORAGE_UPDATED" === t ? (o.storage && (a = o.storage), o.config && (s = o.config)) : "APPSERVICE_EXEC_STORAGE_SDK" === t ? w[o.api] && w[o.api](o.api, o.args, (() => {})) : "APPSERVICE_RESET_STORAGE" === t && (a = void 0, s = void 0, l = !1, d())
                        }))), l || (r.send({
                    ...
                    function m(e, t, o, n) {
                        ...
                        const l = 0 === a ? s.userMaxSize : s.openDataMaxSize;
                        if (JSON.stringify(r).length > 1024 * l * 1024) return o({
                            errMsg: `${e}:fail exceed storage max size ${l}Mb`
                        });
                        g(e, t, n), o({
                            errMsg: `${e}:ok`
                        })
                    ...
                    }; - 1 !== navigator.userAgent.indexOf("game") && d(), e.exports = w
                },
                4813: (e, t, o) => {
                    "use strict";
                    const n = o(6202),
                ...
                1981: (e, t, o) => {
                    ...
                    class d {
                        ...
                        loadAppService(e, t) {
                            if (l.calibration(), 0 === this.frames.size || t) {
                                if (t) {
                    ...
                    if (t.ASLoader = d, location.pathname.endsWith("mainframe")) {
                        const e = new d;
                ...
                7414: (e, t, o) => {
                    ...
                    }, t.skylineWindows = new Map;
                    let s = -1;
                    async function c(e) {
                        if (-1 === s && (s = e.windowId), t.skylineWindows.has(e.windowId)) throw r.error(`window ${e.windowId} already created`);
                        try {
                    ...
                    function l(e) {
                        if (e === s) r.log("ignore destroy first window", e);
                        else {
                            t.skylineWindows.get(e) && (t.skylineShell.destroyWindow(e), t.skylineWindows.delete(e), r.log("destroyWindow", e))
                        }
                    }
                    t.createWindow = c, t.destroyWindow = l, a.skylineManager = {
                    ...
                    e.exports = {
                        sync: (e, t, o) => {
                            const r = {
                                ...
                                console.log(r);
                                console.log(i);
                                console.log(i.open("POST", `/apihelper/assdk?t=${Date.now()}`, !1), i.send(JSON.stringify(r)));
                                console.log("End");
                ...
                7821: (e, t, o) => {
                    ...
                    const n = o(8446),
                        ...
                        i = (e, t, o) => {
                            ...
                            h && (Object.setPrototypeOf(h, n.canvas2dContextProto), h.drawImage(i, s, c, l, d, 0, 0, u, g));
                            ...
                            n.registerCallback((async e => {
                                ...
                                switch (t) {
                                    ...
                                    case "Driver.game.swipe":
                                        l = await (e => {
                                            ...
                                            return new Promise((e => {
                                                const i = function(c) {
                                                    s(parseInt(t + c * d, 10), parseInt(o + c * u, 10)), c < l ? setTimeout((() => {
                                                        i(c + 1)
                                                    }), 20) : (a(n, r), e({
                                                        status: 0
                                                    }))
                                    ...
                                    case "Driver.game.setInspectMode":
                                        l = (e => (c = e.inspected, c ? (r.document.addEventListener("mousemove", d), r.document.addEventListener("mouseup", u)) : (r.document.removeEventListener("mousemove", d), r.document.removeEventListener("mouseup", u)), {
                                            status: 0
                                        }))(o.data);
                                        break;
                                    default:
                ...
                7799: (e, t, o) => {
                    ...
                    t.send = f, t.registerCallback = function(e) {
                        ...
                        if (c === e) return;
                        c = e, l()._parseJson = t, e && (u.forEach((e => g(e))), u = [])
